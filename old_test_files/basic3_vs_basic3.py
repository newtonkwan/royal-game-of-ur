# BasicThree vs. BasicThree
# an arena to match up BasicThree vs BasicThree in 3x4, no flower, 0-2 die Ur. 

# BasicThree 
# In order of options:
# 1) Preference one: get a piece to the end tile
# 2) Preference two: send an opponenet's piece home
# 3) Random play 
...
print("BasicThree vs BasicThree")
while True:
	try: 
...
# BasicThree testing game statistics 
